<script lang="ts">
	import { PLUGIN_NAME } from "./main.js";
	export let error;
	export let src;
	...
	function getFriendlyErrorMessage(errorMessage: string, jsonString: string, errorPosition: number): string {
	...
	function renderJsonWithError(jsonString: string, errorPosition: number, errorMessage: string): string {
